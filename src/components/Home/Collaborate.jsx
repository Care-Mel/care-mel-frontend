...
const Collaborate = () => {
  return (
    <div className="mx-auto px-5 md:px-10 py-4 lg:px-0 lg:w-[1000px] sm:py-6 md:py-8 mt-1 sm:mt-2 md:mt-5">
      <div className="mb-10 flex flex-col md:flex-row justify-center md:bg-primary md:ps-5 text-white rounded-lg md:shadow-lg md:py-10">
        {/* <div className="flex gap-4 md:gap-10"> */}
        <div className="mb-4 md:mb-0 md:w-1/3 md:bg-priamry text-primary md:text-white py-5 md:px-10 md:p-0 rounded-3xl">
          <h3 className="text-[16px] md:text-[12px] lg:text-[16px] font-semibold">
            Registered Caregivers
          </h3>
          <p className="sm:text-[32px] md:text-[18px] text-[32px] mt-2 font-bold">
            {" "}
        ...
        <div className="mb-4 md:mb-0 md:w-1/3 md:bg-priamry text-primary md:text-white py-5 md:px-10 md:p-0 rounded-3xl">
          <h3 className="text-[18px] md:text-[12px] text-[18px] font-bold">
            Trusted by Families
          </h3>
          <p className="sm:text-[32px] md:text-[18px] text-[32px] mt-2 font-bold">
